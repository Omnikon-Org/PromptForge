    ...
    <div className="min-h-screen bg-[#050608] text-[#9CA3AF] font-sans selection:bg-[#3B82F6] selection:text-white">
      <JsonLd
        ...
        data={{
          ...
          potentialAction: {
            '@type': 'SearchAction',
            target: 'https://promptforge.dev/docs?q={search_term_string}',
      ...
      <JsonLd
        ...
        data={{
          name: 'PromptForge',
          url: 'https://promptforge.dev',
          logo: 'https://promptforge.dev/PromptForgeLogo.png',
          sameAs: ['https://github.com/Omnikon-Org/PromptForge', 'https://twitter.com/promptforge'],
        }}
      />
      <main className="flex flex-col items-center overflow-hidden">
        ...
        <section className="w-full max-w-6xl px-6 pt-32 pb-24 flex flex-col items-center text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight mb-6 animate-in slide-in-from-bottom-4 fade-in duration-700">
            Write Prompts Like Code.
          </h1>
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mb-12 animate-in slide-in-from-bottom-4 fade-in duration-700 delay-100 fill-mode-both">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-24 animate-in slide-in-from-bottom-4 fade-in duration-700 delay-200 fill-mode-both">
            <Link
              href="/studio"
          ...
          <div className="w-full bg-[#0B0D11] border border-white/[0.08] rounded-xl overflow-hidden shadow-2xl flex flex-col md:flex-row text-left font-mono text-xs animate-in slide-in-from-bottom-8 fade-in duration-700 delay-300 fill-mode-both">
